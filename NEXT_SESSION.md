...
- **Полевой хвост от HYG-6:** удаление данных, недельный отчёт без сети, шторка подтверждения, +15 с на острове — четыре пути, которые тесты кроют исходником, а не пальцем
