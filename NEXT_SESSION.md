...
> Обновлено 2026-09-10 (HYG-6: гард ночи влит, три PR закрыты). Осталось поле: Gio
...
- Свободно агенту: **LAUNCH-10** (сверка чеклиста; п. 7 — `npm run smoke:prod`) + **AGENT-8**, **HYG-5**
- **HYG-6 — осталось ребейзить 13**, вердикты в хендоффе, § «HYG-6 — разбор очереди». Закрыты #243/#294/#286, гард ночи влит — **AGENT-9** разблокирована
- Свободна и трек не блокирует: **EX-RU-1** — русские имена упражнений, хендофф § «После LAUNCH-10»
- **AI-1 (новая, до раздачи ссылки):** движок Anthropic виден в настройках, ключа на бэкенде нет — выбравший его получает 500
- **Не брать до закрытия трека: MOTION-FIX** — хендофф, § «После LAUNCH-10»
- Закрыты: LAUNCH-1/2, **3A**, **3B**, **4**, **5A**, **5B**, **6**, **7**, **8**, **9 pts 3–7 (F-10, F-11, F-7/F-8)**, **PC-1**, **PC-2**, AGENT-1/2/3/**4**/5/6/**7**, **FLOW-5**, **BOOT-TRIM**
- **Хвост уборки:** `main` держит ворктри `athlete-pro-orm-bars` (чист) — снести и вернуть `main` в корень
