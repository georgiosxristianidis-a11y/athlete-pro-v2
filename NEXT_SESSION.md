...
> Обновлено 2026-09-08 (AGENT-4 закрыта замером). Карточек новой сессии нет. Осталось поле: Gio
...
- Закрыты: LAUNCH-1/2, **3A**, **3B**, **4**, **5A**, **5B**, **6**, **7**, **8**, **9 pts 3–7 (F-10, F-11, F-7/F-8)**, **PC-1**, **PC-2**, AGENT-1/2/3/**4**/5/6, **FLOW-5**
