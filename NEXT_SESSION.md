...
> Обновлено 2026-09-14 (архитектурный трек: Фаза 3 открыта, A1 закрыта). Осталось поле: Gio
...
- **Архитектурный трек:** фазы 0-4 — хендофф Cursor § «Порядок работ». Фазы 0-2 закрыты целиком. Фаза 3: `A1` закрыта (14.09) → `A8` → `A15` → `A2` → `A5` → `A9`/`A13`
