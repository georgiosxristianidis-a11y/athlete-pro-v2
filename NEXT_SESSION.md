...
- `HANDOFF_gemini_audit_triage.md` → **PERF-3** (20 `modulepreload`), следом SCAF-1/NOISE-1/PII-1; PERF-1/2 закрыты, бандл не берём; за Gio — снести Render, отозвать `ANTHROPIC_API_KEY`
