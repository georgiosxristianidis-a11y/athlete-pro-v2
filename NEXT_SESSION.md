...
> Обновлено 2026-09-10 (заведены AGENT-9, HYG-6). Осталось поле: Gio
...
- Закрыты: LAUNCH-1/2, **3A**, **3B**, **4**, **5A**, **5B**, **6**, **7**, **8**, **9 pts 3–7 (F-10, F-11, F-7/F-8)**, **PC-1**, **PC-2**, AGENT-1/2/3/**4**/5/6/**7**, **FLOW-5**
