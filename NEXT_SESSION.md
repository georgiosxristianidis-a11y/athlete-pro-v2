...
> Обновлено 2026-08-27 (разбор мультиагента: FLOW-5 и AGENT-5 влиты, следующая — AGENT-6).
...
- **AGENT-6** — следующая: `npm run scorecard` падает на дефолтном вызове, блокирует AGENT-4
- **LAUNCH-3B** — продуктовая следующая (ссылки на документы из приватности, по `getLang()`)
- **LAUNCH-5B**, дальше LAUNCH-4 (счётчик, PR #243), 6..10; **AGENT-7/8**, **HYG-5** открыты
- Закрыты: LAUNCH-1/2, **3A**, **5A**, AGENT-1/2/3/5, **FLOW-5**. Нарядов в работе нет
