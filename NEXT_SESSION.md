...
- **LAUNCH-4** — следующая свободная (внешний счётчик, PR #243); дальше LAUNCH-6..10
- **LAUNCH-3A** и **LAUNCH-5A** выданы Cursor — не брать; LAUNCH-1/2 и AGENT-1/2/3 закрыты
- **LAUNCH-3B**, **LAUNCH-5B** ждут мёржа PR #255 (`js/locale.store.js`, `sw.js`)
- **AGENT-4** — гард на подпись, ждёт две недели замера `npm run scorecard`
