...
> Обновлено 2026-08-29 (#281 влит `b1e7d62`; PC-1 заведена). Gio: ключи + iPhone
...
- **Сейчас — LAUNCH-10** (чеклист + ссылка). #243 не вливать. Трек **не закрыт** — Gio
- **PC-1** — настройки ИИ и выбор движка → шторка P.A.N.D.A. Core: `HANDOFF_panda_core_settings.md`. Вторая живая линия, решение Gio 29.08
- Хвост **LAUNCH-9** пункты 5–7 (F-10, F-11, F-7/F-8) — не в этом заходе
- Gio: ключи Vercel + verify (`LAUNCH-6`); живой iPhone (`LAUNCH-7`)
- **Gio gate:** блокеры — `docs/LAUNCH_CHECKLIST.md` § «Блокеры до…» (ключи, iPhone, полевой п. 1, ссылка живому)
- Свободны также: **AGENT-7/8**, **HYG-5**. **AGENT-4** ждёт окно наблюдения до 08.09 (`unsigned` = 6)
- Закрыты: LAUNCH-1/2, **3A**, **3B**, **4**, **5A**, **5B**, **7**, **8**, **9 pts 3–4**, AGENT-1/2/3/5/6, **FLOW-5**
