...
> Обновлено 2026-08-27 (AGENT-6 закрыта, LAUNCH-3B выдана Cursor).
...
- **LAUNCH-3B** выдана Cursor 27.08 — не брать; **LAUNCH-5B** ждёт её (общий `locale.store.js`)
- Свободны: **LAUNCH-4** (счётчик, PR #243), 6..10; **AGENT-7/8**, **HYG-5**
- **AGENT-4** — замер разблокирован: `npm run scorecard`, графа `unsigned` = 6 из 100 PR
- Закрыты: LAUNCH-1/2, **3A**, **5A**, AGENT-1/2/3/5/6, **FLOW-5**
