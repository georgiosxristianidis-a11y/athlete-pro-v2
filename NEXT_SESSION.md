...
> Обновлено 2026-08-28 (LAUNCH-6 #271 · LAUNCH-5B #272 в main; LAUNCH-9 F-6/F-9 этим PR). Gio: ключи
...
- **Следующая после влития 9 — LAUNCH-4** (счётчик, PR #243), затем 7/8/10
- Хвост **LAUNCH-9** пункты 5–7 (F-10, F-11, F-7/F-8) — не в этом заходе
- Gio: ключи Vercel + verify (`LAUNCH-6`)
- Свободны также: **AGENT-7/8**, **HYG-5**. **AGENT-4** ждёт окно наблюдения до 08.09 (`unsigned` = 6)
- Закрыты: LAUNCH-1/2, **3A**, **3B**, **5A**, **5B**, AGENT-1/2/3/5/6, **FLOW-5**
