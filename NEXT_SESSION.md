...
> Обновлено 2026-08-27 (LAUNCH-6 код в main #271; LAUNCH-5B в работе).
...
- **Следующая — LAUNCH-5B** (остальные слои на t()). 6-код влит (#271); Gio: ключи + verify
- Затем пункты 3–4 **LAUNCH-9** (F-6, F-9), **LAUNCH-4** (счётчик, PR #243), 7/8/10
- **Не начинать 9 пока 5B не в main** — пересечение `onboarding.js`
