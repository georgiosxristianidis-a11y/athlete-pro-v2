...
> Обновлено 2026-09-10 (закрыта BOOT-TRIM, PR #312/#321 влиты). Осталось поле: Gio
...
- **Первым — HYG-6:** 21 открытый PR, 14 с `cursor/*`. **AGENT-9** (ночной прогон) — только после неё
