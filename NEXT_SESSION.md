...
> Обновлено 2026-08-30 (PC-2 влита `7cb1394`, 1.27.81 на проде). Осталось поле: Gio
...
- Свободно агенту: **LAUNCH-9** пункты 5–7 — F-10 (Back не закрывает Athlete Room) дороже прочих, затем F-11, F-7/F-8
- Свободны также: **AGENT-7/8**, **HYG-5** (83 невлитых ветки в WARN). **AGENT-4** ждёт окно до 08.09 (`unsigned` = 6)
- Закрыты: LAUNCH-1/2, **3A**, **3B**, **4**, **5A**, **5B**, **6**, **7**, **8**, **9 pts 3–4**, **PC-1**, **PC-2** (линия PANDA Core в архиве), AGENT-1/2/3/5/6, **FLOW-5**
