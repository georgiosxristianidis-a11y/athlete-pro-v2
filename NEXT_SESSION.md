...
> Обновлено 2026-09-13 (NAV-1 закрыта, Фаза 2 открыта). Осталось поле: Gio
...
- Свободно агенту: **LAUNCH-10** (сверка чеклиста; п. 7 — `npm run smoke:prod`) + **AGENT-8**, **HYG-5**, **AGENT-9** (разблокирована закрытием HYG-6)
...
- **Перф-трек (13.09):** фазы 0-4 — хендофф Cursor § «Порядок работ». Фаза 1 (кадр) вся закрыта. Свободны **MEASURE-1** (Фаза 0) и, в Фазе 2 (стабильность ввода), **DRUM-TICK**/**A3**/**A6+A7** — **NAV-1** закрыта (13.09)
...
- Закрыты: LAUNCH-1/2, **3A**, **3B**, **4**, **5A**, **5B**, **6**, **7**, **8**, **9 pts 3–7 (F-10, F-11, F-7/F-8)**, **PC-1**, **PC-2**, AGENT-1/2/3/**4**/5/6/**7**, **FLOW-5**, **BOOT-TRIM**, **VOICE-2**, **HYG-6**
