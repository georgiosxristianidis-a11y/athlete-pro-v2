...
> Обновлено 2026-09-14 (архитектурный трек: Фаза 3, A1+A8 закрыты). Осталось поле: Gio
...
- **Архитектурный трек:** фазы 0-4 — хендофф Cursor § «Порядок работ». Фазы 0-2 закрыты. Фаза 3: `A1`+`A8` закрыты, `A15` правило заведено 14.09 → `A2` → `A5` → `A9`/`A13`
