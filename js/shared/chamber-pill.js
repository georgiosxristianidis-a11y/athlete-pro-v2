...
import { blockLabel, BLOCK_NAMES_EN } from './block-names.js';

export { blockLabel, BLOCK_NAMES_EN };
...
/**
 * Каноническая карта названий блоков (`blockLabel`, `BLOCK_NAMES_EN`) переехала
 * в `js/shared/block-names.js` (A5) — ноль DOM, чтобы `workout.store.js` не тянул
 * этот файл ради констант. Реэкспорт выше сохраняет прежние импорты.
 */
