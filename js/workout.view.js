...
/* ════════════════════════════════════════════════════════
   ...
   ════════════════════════════════════════════════════════ */
/**
 * Open the plan editor modal for editing push/pull/legs exercises.
 * @returns {void}
 */
...
/**
 * Switch the active tab in the plan editor modal.
...
/**
 * Toggle a pre-workout checklist item.
 * @param {number} i — checklist item index
 * @returns {void}
 */
...
/**
 * Save the current plan state and close the editor modal.
 * @returns {void}
 */
...
/**
 * Update an exercise name in the plan.
 * @param {'push'|'pull'|'legs'} type
...
/**
 * Adjust a plan exercise field (sets or reps) by a delta.
 * @param {'push'|'pull'|'legs'} type
 * @param {number} i — exercise index
 * @param {'sets'|'reps'} field — field to adjust
...
/**
 * Delete an exercise from a plan tab.
 * @param {'push'|'pull'|'legs'} type
 * @param {number} i — exercise index to delete
 * @returns {void}
 */
...
/* ════════════════════════════════════════════════════════
   ...
   ════════════════════════════════════════════════════════ */
/**
 * Step the weight value for a set by a delta.
 * @param {number} ei — exercise index
 * @param {number} si — set index
 * @param {number} delta — weight change in kg (e.g., 2.5 or -2.5)
 * @returns {void}
 */
...
/**
 * Step the reps value for a set by a delta.
 * @param {number} ei — exercise index
 * @param {number} si — set index
 * @param {number} delta — reps change (+1 or -1)
 * @returns {void}
 */
...
/**
 * Enter inline edit mode for a stepper value.
 * @param {'w'|'r'} type — 'w' for weight, 'r' for reps
 * @param {number} ei — exercise index
 * @param {number} si — set index
 * @returns {void}
 */
...
/**
 * Commit an inline edit value back to state.
 * @param {'w'|'r'} type — 'w' for weight, 'r' for reps
 * @param {number} ei — exercise index
 * @param {number} si — set index
 * @returns {void}
...
/* ════════════════════════════════════════════════════════
   ...
   ════════════════════════════════════════════════════════ */
/**
 * Set the RPE rating for a set (toggles off if same value selected).
 * @param {number} ei — exercise index
 * @param {number} si — set index
 * @param {number} val — RPE value (6-10)
 * @returns {void}
 */
...
/**
 * Toggle a set's done state and start/stop the rest timer.
 * @param {number} ei — exercise index
 * @param {number} si — set index
 * @returns {void}
 */
...
/* ════════════════════════════════════════════════════════
   ...
   ════════════════════════════════════════════════════════ */
/**
 * Toggle collapse/expand of an exercise card.
 * @param {number} ei — exercise index
 * @returns {void}
 */
...
/* ════════════════════════════════════════════════════════
   ...
   ════════════════════════════════════════════════════════ */
/**
 * Open the replace exercise modal for an exercise card.
