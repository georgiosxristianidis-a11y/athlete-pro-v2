...
function _iconPassport() {
  return `<svg viewBox="0 0 24 24" fill="none" stroke="var(--c-secondary)"
...
/* ════════════════════════════════════════════════════════
   PUBLIC API — только импортом. Глобала window.Privacy нет: он стоял
   в app.js и держал privacy.view на бут-графе, а читателей у него
   не было ни одного (BOOT-TRIM, 2026-09-12).
   ════════════════════════════════════════════════════════ */
