...
describe('body fat', () => {
  ...
  test('resolveSex prefers profile.sex over a missing or male legacy key', () => {
  ...
  test('female Navy result is not the male formula on the same tape', () => {
...
describe('view wiring', () => {
  ...
  test('view reads profile.sex before the legacy sex key', () => {
